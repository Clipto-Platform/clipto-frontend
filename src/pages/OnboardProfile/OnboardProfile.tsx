              ...
              <Formik
                initialValues={(() => {
                  return {
                    ...
                    lensHandle: (lensProfiles.length > 0 && lensProfiles[0].handle) 
                ...
                validate={async (values) => {
                  ...
                  //lens validation
                  if (createLens) {
                    let aggLensHandle = lensHandle == CREATE_LENS_TEXT ? userProfileDB?.twitterHandle || userProfile.twitterHandle || values.userName : lensHandle
                    const getProfileByHandleRes = await lens.getProfileByHandle(config.lens.getHandleToSearch(aggLensHandle))
                  ...
                  return (
                    <>
                      ...
                      <div style={{ marginBottom: 12 }}>
                        {((lensProfiles.length > 0 && !ENABLE_LENS_PROFILE_CREATION) || (ENABLE_LENS_PROFILE_CREATION)) && <Dropdown
