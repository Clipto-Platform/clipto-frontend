 ...
 */
export const signMessage = async (library: Web3Provider | undefined, account: string | null | undefined, message: string): Promise<any> => {
  if (!library) {
    throw {
...
export const isCreatorOnChain = async (exchangeContract: CliptoExchange, account: string | null | undefined): Promise<boolean> => {
