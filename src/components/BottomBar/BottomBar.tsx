    ...
    <>
      <BottomBarWrapper style={{ paddingBottom: 20 }}>
        ...
        <div style={{ marginBottom: 80 }}>
          {DISCORD_LINK && (
            <a href={DISCORD_LINK} style={{ marginRight: 20, marginLeft: 20 }}>
              <SiDiscord style={{ width: SOCIAL_SIZE, height: SOCIAL_SIZE }} />
            </a>
          )}
          {TWITTER_LINK && (
            <a href={TWITTER_LINK} style={{ marginRight: 20, marginLeft: 20 }}>
              <SiTwitter style={{ width: SOCIAL_SIZE, height: SOCIAL_SIZE }} />
            </a>
          )}
          {HELP_EMAIL && (
            <a href={'mailto:' + HELP_EMAIL} style={{ marginRight: 20, marginLeft: 20 }}>
        ...
        <div style={{ marginBottom: 20 }}>
          {DOCS_LINK && (
            <a href={DOCS_LINK} style={{ marginRight: 10, marginLeft: 10 }}>
              Docs
            </a>
          )}
          {TERMS_LINK && (
            <a href={TERMS_LINK} style={{ marginRight: 10, marginLeft: 10 }}>
              Terms
            </a>
          )}
          {PRIVACY_LINK && (
            <a href={PRIVACY_LINK} style={{ marginRight: 10, marginLeft: 10 }}>
              Privacy
            </a>
          )}
        </div>
