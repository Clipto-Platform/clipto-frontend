...
export interface CliptoToken extends BaseContract {
  ...
  setMinter(_minter: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    initialize(_owner: string, _minter: string, _creatorName: string, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    setMinter(_minter: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
