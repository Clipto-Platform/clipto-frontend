...
export interface CliptoExchangeInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'newRequest', values: [string, string]): string;
...
export type CreatorUpdatedEvent = TypedEvent<[string, string], { creator: string; data: string }>;
...
export interface CliptoExchange extends BaseContract {
  ...
  callStatic: {
    ...
    newRequest(creator: string, data: string, overrides?: CallOverrides): Promise<void>;

    owner(overrides?: CallOverrides): Promise<string>;

    refundRequest(creator: string, index: BigNumberish, overrides?: CallOverrides): Promise<void>;

    registerCreator(creatorName: string, data: string, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    CreatorRegistered(creator?: string | null, token?: string | null, data?: null): CreatorRegisteredEventFilter;

    'CreatorUpdated(address,string)'(creator?: string | null, data?: null): CreatorUpdatedEventFilter;
    CreatorUpdated(creator?: string | null, data?: null): CreatorUpdatedEventFilter;
  ...
  estimateGas: {
    ...
    updateCreator(details: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
