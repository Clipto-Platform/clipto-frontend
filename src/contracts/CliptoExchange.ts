...
export interface CliptoExchangeInterface extends utils.Interface {
  functions: {
    ...
    'modifyCreator(uint256)': FunctionFragment;
    'newRequest(address)': FunctionFragment;
    'refundRequest(address,uint256)': FunctionFragment;
    'registerCreator(string,uint256)': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: 'modifyCreator', values: [BigNumberish]): string;
  ...
  encodeFunctionData(functionFragment: 'registerCreator', values: [string, BigNumberish]): string;
  ...
  events: {
    'CreatorModified(address,uint256)': EventFragment;
    'CreatorRegistered(address,uint256,address)': EventFragment;
...
export type CreatorModifiedEvent = TypedEvent<[string, BigNumber], { creator: string; cost: BigNumber }>;
...
export type CreatorRegisteredEvent = TypedEvent<
  ...
  { creator: string; cost: BigNumber; tokenAddress: string }
>;
...
export interface CliptoExchange extends BaseContract {
  ...
  functions: {
    ...
    ): Promise<[BigNumber, string] & { cost: BigNumber; token: string }>;
  ...
  creators(arg0: string, overrides?: CallOverrides): Promise<[BigNumber, string] & { cost: BigNumber; token: string }>;
  ...
  callStatic: {
    ...
    modifyCreator(cost: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    registerCreator(creatorName: string, cost: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    'CreatorModified(address,uint256)'(creator?: string | null, cost?: null): CreatorModifiedEventFilter;
    CreatorModified(creator?: string | null, cost?: null): CreatorModifiedEventFilter;

    'CreatorRegistered(address,uint256,address)'(
      creator?: string | null,
      cost?: null,
      tokenAddress?: null,
    ): CreatorRegisteredEventFilter;
    CreatorRegistered(creator?: string | null, cost?: null, tokenAddress?: null): CreatorRegisteredEventFilter;
  ...
  estimateGas: {
    ...
    modifyCreator(cost: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
